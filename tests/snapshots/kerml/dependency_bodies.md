...
(parsed-document
  ...
  (root (package (name "DependencyBodies") (body brace (kerml-feature (name "x")) (kerml-feature (name "y")) (dependency (clients (ref r0)) (suppliers (ref r1)) (body semicolon)) (dependency (clients (ref r2)) (suppliers (ref r3) (ref r4)) (body brace (doc) (kerml-feature))))))
)
~~~
