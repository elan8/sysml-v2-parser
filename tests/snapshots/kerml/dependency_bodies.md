...
(parsed-document
  ...
  (root (package (name "DependencyBodies") (body (kerml-feature (name "x")) (kerml-feature (name "y")) (dependency (clients (ref r0)) (suppliers (ref r1)) (body none)) (dependency (clients (ref r2)) (suppliers (ref r3) (ref r4)) (body (doc) (kerml-feature))))))
)
~~~
