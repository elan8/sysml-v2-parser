...
(parsed-document
  ...
  (root (package (name "RelationshipCoverage") (body brace (kerml-classifier (keyword type) (abstract false) (name "A") (specializes none) (body semicolon)) (kerml-classifier (keyword type) (abstract false) (name "B") (specializes none) (body semicolon)) (kerml-feature (prefix (head basic) (direction none) (derived false) (abstract false) (portion none) (variability none) (metadata)) (kind feature) (member false) (all false) (name "f") (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r0)))) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (references none) (crosses none) (relationships) (value none) (body semicolon)) (kerml-feature (prefix (head basic) (direction none) (derived false) (abstract false) (portion none) (variability none) (metadata)) (kind feature) (member false) (all false) (name "g") (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (references none) (crosses none) (relationships) (value none) (body semicolon)) (kerml-relationship (keyword subclassifier) (source (ref r1)) (target (ref r2))) (kerml-relationship (keyword subclassifier) (source (ref r3)) (target (ref r4))) (kerml-relationship (keyword typing) (source (ref r5)) (target (ref r6))) (kerml-relationship (keyword typing) (source (ref r7)) (target (ref r8))) (kerml-relationship (keyword subset) (source (ref r9)) (target (ref r10))) (kerml-relationship (keyword redefinition) (source (ref r11)) (target (ref r12))) (kerml-relationship (keyword disjoint) (source (ref r13)) (target (ref r14))) (kerml-relationship (keyword disjoint) (source (ref r15)) (target (ref r16))) (kerml-relationship (keyword inverse) (source (ref r17)) (target (ref r18))) (kerml-relationship (keyword featuring) (source (ref r19)) (target (ref r20))) (kerml-classifier (keyword type) (abstract false) (name "UnionType") (specializes none) (body semicolon)) (kerml-classifier (keyword type) (abstract false) (name "InterType") (specializes none) (body semicolon)) (kerml-classifier (keyword type) (abstract false) (name "DiffType") (specializes none) (body semicolon)) (kerml-classifier (keyword classifier) (abstract false) (name "X") (specializes none) (body semicolon)) (default-reference-usage (prefix (direction none) (derived false) (variance none) (constant false)) (declaration-name "causeA") (short-name none) (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value none) (body semicolon)) (default-reference-usage (prefix (direction none) (derived false) (variance none) (constant false)) (declaration-name "y") (short-name none) (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value (feature-value (kind bind) (default false) (expression (expression (span (offset 548) (line 20) (column 9) (len 1)) (ref r21))))) (body semicolon)))))
)
~~~
