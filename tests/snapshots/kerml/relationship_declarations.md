...
(parsed-document
  (references
    ...
    (reference r21 (scope relative) (span (offset 450) (line 16) (column 16) (len 16)) (segments (segment 0 (token "later") (name "later") (separator none) (span (offset 450) (line 16) (column 16) (len 5))) (segment 1 (token "successors") (name "successors") (separator dot) (span (offset 456) (line 16) (column 22) (len 10)))))
    (reference r22 (scope relative) (span (offset 475) (line 16) (column 41) (len 18)) (segments (segment 0 (token "earlier") (name "earlier") (separator none) (span (offset 475) (line 16) (column 41) (len 7))) (segment 1 (token "successors") (name "successors") (separator dot) (span (offset 483) (line 16) (column 49) (len 10)))))
    (reference r23 (scope relative) (span (offset 512) (line 17) (column 18) (len 18)) (segments (segment 0 (token "earlier") (name "earlier") (separator none) (span (offset 512) (line 17) (column 18) (len 7))) (segment 1 (token "successors") (name "successors") (separator dot) (span (offset 520) (line 17) (column 26) (len 10)))))
    (reference r24 (scope relative) (span (offset 536) (line 17) (column 42) (len 18)) (segments (segment 0 (token "later") (name "later") (separator none) (span (offset 536) (line 17) (column 42) (len 5))) (segment 1 (token "predecessors") (name "predecessors") (separator dot) (span (offset 542) (line 17) (column 48) (len 12)))))
    (reference r25 (scope relative) (span (offset 704) (line 24) (column 9) (len 1)) (segments (segment 0 (token "f") (name "f") (separator none) (span (offset 704) (line 24) (column 9) (len 1)))))
  )
  (root (package (name "RelationshipCoverage") (body brace (kerml-classifier (keyword type) (abstract false) (name "A") (specializes none) (conjugates none) (body semicolon)) (kerml-classifier (keyword type) (abstract false) (name "B") (specializes none) (conjugates none) (body semicolon)) (kerml-feature (prefix (head basic) (direction none) (derived false) (abstract false) (portion none) (variability none) (metadata)) (kind feature) (member false) (all false) (name "f") (specializations (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r0))))) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (relationships) (value none) (body semicolon)) (kerml-feature (prefix (head basic) (direction none) (derived false) (abstract false) (portion none) (variability none) (metadata)) (kind feature) (member false) (all false) (name "g") (specializations) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (relationships) (value none) (body semicolon)) (kerml-relationship (keyword subclassifier) (declaration-keyword true) (source (ref r1)) (target (ref r2))) (kerml-relationship (keyword subclassifier) (declaration-keyword false) (source (ref r3)) (target (ref r4))) (kerml-relationship (keyword typing) (declaration-keyword false) (source (ref r5)) (target (ref r6))) (kerml-relationship (keyword typing) (declaration-keyword false) (source (ref r7)) (target (ref r8))) (kerml-relationship (keyword subset) (declaration-keyword false) (source (ref r9)) (target (ref r10))) (kerml-relationship (keyword redefinition) (declaration-keyword false) (source (ref r11)) (target (ref r12))) (kerml-relationship (keyword disjoint) (declaration-keyword true) (source (ref r13)) (target (ref r14))) (kerml-relationship (keyword disjoint) (declaration-keyword false) (source (ref r15)) (target (ref r16))) (kerml-relationship (keyword inverse) (declaration-keyword false) (source (ref r17)) (target (ref r18))) (kerml-relationship (keyword featuring) (declaration-keyword false) (source (ref r19)) (target (ref r20))) (kerml-classifier (keyword type) (abstract false) (name "RelationshipOwner") (specializes none) (conjugates none) (body brace (kerml-relationship (keyword subset) (declaration-keyword false) (source (ref r21)) (target (ref r22))) (kerml-relationship (keyword disjoint) (declaration-keyword false) (source (ref r23)) (target (ref r24))))) (kerml-classifier (keyword type) (abstract false) (name "UnionType") (specializes none) (conjugates none) (body semicolon)) (kerml-classifier (keyword type) (abstract false) (name "InterType") (specializes none) (conjugates none) (body semicolon)) (kerml-classifier (keyword type) (abstract false) (name "DiffType") (specializes none) (conjugates none) (body semicolon)) (kerml-classifier (keyword classifier) (abstract false) (name "X") (specializes none) (conjugates none) (body semicolon)) (default-reference-usage (prefix (direction none) (derived false) (variance none) (constant false)) (declaration-name "causeA") (short-name none) (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value none) (body semicolon)) (default-reference-usage (prefix (direction none) (derived false) (variance none) (constant false)) (declaration-name "y") (short-name none) (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value (feature-value (kind bind) (default false) (expression (expression (span (offset 704) (line 24) (column 9) (len 1)) (ref r25))))) (body semicolon)))))
)
~~~
