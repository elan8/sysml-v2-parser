...
(parsed-document
  ...
  (root (package (name "NestedClassifiers") (body (part-usage) (part-def (name "PD") (body (kerml-classifier (keyword struct) (name "S1")) (kerml-classifier (keyword datatype) (name "D1")))) (attribute-def))))
)
~~~
