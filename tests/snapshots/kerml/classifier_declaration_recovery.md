...
(parsed-document
  ...
  (root (library-package (name "Broken") (standard true) (body brace (kerml-classifier (keyword metaclass) (abstract false) (name "M") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r0)))) (body brace (malformed (code "recovered_calc_body_element") (found "in : ;") (span (offset 80) (line 3) (column 9) (len 15))) (kerml-feature (prefix (head basic) (direction none) (derived false) (abstract false) (portion none) (variability var) (metadata)) (kind feature) (member false) (all false) (name "ok") (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r1)))) (multiplicity (lower (expression (span (offset 120) (line 4) (column 34) (len 1)) (integer 1))) (upper (expression (span (offset 120) (line 4) (column 34) (len 1)) (integer 1)))) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (references none) (crosses none) (relationships) (value none) (body semicolon)))))))
)
~~~
