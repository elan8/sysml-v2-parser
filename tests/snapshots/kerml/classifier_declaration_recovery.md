...
(parsed-document
  ...
  (root (library-package (name "Broken") (standard true) (body brace (kerml-classifier (keyword metaclass) (abstract false) (name "M") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r0)))) (body brace (malformed (code "recovered_calc_body_element") (found "in : ;") (span (offset 80) (line 3) (column 9) (len 15))) (kerml-feature (name "ok") (relationships) (value none) (body semicolon)))))))
)
~~~
