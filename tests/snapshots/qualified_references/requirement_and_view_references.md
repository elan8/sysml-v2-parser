...
(parsed-document
  ...
  (root (package (name "P") (body brace (dependency (clients (ref r0)) (suppliers (ref r1)) (body none)) (requirement-def (name "R") (body brace (subject (name "s") (type (ref r2)) (redefines none) (value none)) (actor (name "a") (type (ref r3))) (verify (target (ref r4)) (redefines (ref r5))))) (view (name "v") (type (ref r6)) (body brace (satisfy (viewpoint (ref r7))))))))
)
~~~
