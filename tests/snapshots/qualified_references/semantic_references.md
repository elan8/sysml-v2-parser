...
(parsed-document
  ...
  (root (package (name "Demo") (body (import (target (ref r0) (shape (namespace (recursive false))))) (import (target (ref r1) (shape (membership (recursive true))))) (import (target (ref r2) (shape (filter (recursive false) (members (ref r3)))))) (dependency (clients (ref r4)) (suppliers (ref r5))) (requirement-def (name "Req") (body (subject (name "item") (type (ref r6)) (value (member-access (base (ref r7)) (separator dot) (member (ref r8))))) (verify (target (ref r9)) (redefines (ref r10))))) (view (name "overview") (type (ref r11)) (body (expose (target (ref r12) (shape (membership (recursive false))))) (expose (target (ref r13) (shape (filter (recursive false) (members (ref r14)))))) (satisfy (viewpoint (ref r15))))) (use-case-def (name "Use") (body (include (target (ref r16))))) (requirement-def (name "Roles") (body (stakeholder (declaration "") (target (ref r17)) (type none) (redefinition false)))) (state-def (name "Machine") (body (then (state (ref r18))))) (occurrence (declaration "") (target (ref r19))) (part-def (name "Vehicle") (body (exhibit (declaration "") (state (ref r20))))))))
)
~~~
