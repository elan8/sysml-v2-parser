...
(parsed-document
  ...
  (root (package (name "LoopRecovery") (body (action-def (name "Traverse") (specializes none) (body (for-loop (variable "item") (range (expression (span (offset 69) (line 3) (column 21) (len 27)) (member-access (base (expression (span (offset 69) (line 3) (column 21) (len 13)) (ref r0))) (separator dot) (member (ref r1))))) (body (action-usage (declaration "visit") (type none)))) (malformed (code "recovered_action_body_element") (found "for orphan in Ghost::leaked + {") (span (offset 143) (line 6) (column 9) (len 80))) (action-usage (declaration "later") (type (ref r2))))))))
)
~~~
