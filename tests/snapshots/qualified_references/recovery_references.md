...
(fixture-diagnostics
  (document "recovery_references.md"
    (diagnostics
      (diagnostic (code "missing_semicolon") (severity error) (category parseerror) (span (offset 50) (line 3) (column 5) (len 14)) (message "missing semicolon before next declaration"))
    )
  )
)
~~~
...
(parsed-document
  ...
  (root (package (name "Recovery") (body brace (import (target (span (span (offset 30) (line 2) (column 12) (len 14))) (all none) (ref r0) (shape (namespace (wildcard-suffix (span (span (offset 41) (line 2) (column 23) (len 3))) (separator (span (offset 41) (line 2) (column 23) (len 2))) (marker (span (offset 43) (line 2) (column 25) (len 1)))) (recursive-suffix none) (combined-recursive-suffix-span none))))) (malformed (code "missing_semicolon") (found "not valid") (span (offset 50) (line 3) (column 5) (len 14))) (dependency (clients (ref r1)) (suppliers (ref r2)) (body semicolon)))))
)
~~~
