...
(parsed-document
  ...
  (root (package (name "TransactionalRecovery") (body (malformed (code "recovered_package_body_element") (found "import Ghost::ImportTarget unexpected;") (span (offset 36) (line 2) (column 5) (len 43))) (import (target (ref r0) (shape (membership (recursive-suffix none))))) (malformed (code "recovered_package_body_element") (found "alias broken for Ghost::AliasTarget unexpected;") (span (offset 111) (line 5) (column 5) (len 52))) (alias (name "live") (target (ref r1)) (body semicolon)) (view (name "recoveredView") (type none) (body (malformed (code "recovered_view_body_element") (found "expose Ghost::ExposeTarget unexpected;") (span (offset 231) (line 9) (column 9) (len 47))) (expose (target (ref r2) (shape (membership (recursive-suffix none))))))))))
)
~~~
