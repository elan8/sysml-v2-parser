...
(parsed-document
  ...
  (root (package (name "StateActionTargets") (body (state-def (name "Machine") (body (entry (action-keyword true) (target (ref r0)) (body semicolon)) (do (action-keyword false) (target (ref r1)) (body (inout-declaration))) (exit (action-keyword false) (target (ref r2)) (body semicolon)) (entry (action-keyword false) (target none) (body semicolon)))))))
)
~~~
