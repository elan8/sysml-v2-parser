...
(parsed-document
  ...
  (root (package (name "StateActionTargets") (body brace (state-def (name "Machine") (body brace (entry (action-keyword true) (target (ref r0)) (declared-name none) (type none) (redefines none) (effect false) (body semicolon)) (do (action-keyword false) (target (ref r1)) (declared-name none) (type none) (redefines none) (effect false) (body brace (inout-declaration))) (exit (action-keyword false) (target (ref r2)) (declared-name none) (type none) (redefines none) (effect false) (body semicolon)) (entry (action-keyword false) (target none) (declared-name none) (type none) (redefines none) (effect false) (body semicolon)))))))
)
~~~
