...
(parsed-document
  ...
  (root (package (name "P") (body (state-def (name "S") (body (entry (action-keyword false) (target none) (declared-name none) (type none) (redefines none) (effect false) (body semicolon)) (then (state (ref r0))) (state-usage) (malformed (code "missing_semicolon") (found "transition t first") (span (offset 66) (line 5) (column 5) (len 19))))))))
)
~~~
