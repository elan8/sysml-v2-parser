...
(fixture-diagnostics
  (document "kerml_feature_prefix_slots.md"
    (diagnostics
      (diagnostic (code "recovered_calc_body_element") (severity error) (category parseerror) (span (offset 1021) (line 40) (column 9) (len 20)) (message "unexpected token in calc body"))
    )
  )
)
~~~
