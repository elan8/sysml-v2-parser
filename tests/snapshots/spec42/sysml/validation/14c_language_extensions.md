...
package '14c-Language-Extensions' {
    ...
    package FMEAUserModel {
        ...
        #fmea;
        item def 'Glucose Meter in Use' : 'Glucose FMEA Item' {
            part 'glucose meter' {
                event 'glucose level undetected'[*];
                part battery {
                    event 'battery depleted'[*];
