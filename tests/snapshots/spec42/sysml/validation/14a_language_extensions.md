...
(parsed-document
  ...
  (root (package (name "14a-Language Extensions") (body brace (import (target (span (span (offset 52) (line 2) (column 17) (len 28))) (all none) (ref r0) (shape (namespace (wildcard-suffix (span (span (offset 77) (line 2) (column 42) (len 3))) (separator (span (offset 77) (line 2) (column 42) (len 2))) (marker (span (offset 79) (line 2) (column 44) (len 1)))) (recursive-suffix none) (combined-recursive-suffix-span none))))) (package (name "User Defined Extensions") (body brace (enum-def (name "ClassificationLevel") (body brace (enum-value (name "uncl") (span (offset 160) (line 7) (column 4) (len 4))) (enum-value (name "conf") (span (offset 169) (line 8) (column 4) (len 4))) (enum-value (name "secret") (span (offset 178) (line 9) (column 4) (len 6))))) (metadata-def))) (part-usage (declaration-name "part_X") (typing none) (body brace (metadata-usage))) (part-usage (declaration-name "part_Y") (typing none) (body brace (metadata-annotation (declared-name none) (type (ref r1)) (about) (body brace (element-count 1))))))))
)
~~~
