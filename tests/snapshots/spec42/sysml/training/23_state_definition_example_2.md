...
(parsed-document
  ...
  (root (package (name "State Definition Example-2") (body brace (attribute-def (name "VehicleStartSignal") (multiplicity none)) (attribute-def (name "VehicleOnSignal") (multiplicity none)) (attribute-def (name "VehicleOffSignal") (multiplicity none)) (state-def (name "VehicleStates") (body brace (entry (action-keyword false) (target none) (declared-name none) (type none) (redefines none) (effect false) (body semicolon)) (then (state (ref r0))) (state-usage) (transition) (state-usage) (transition) (state-usage) (transition))))))
)
~~~
