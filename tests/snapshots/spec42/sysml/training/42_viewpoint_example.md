...
(parsed-document
  ...
  (root (package (name "Viewpoint Example") (body brace (part-def (name "Systems Engineer") (modifiers) (body semicolon)) (part-def (name "IV&V") (modifiers) (body semicolon)) (concern-usage) (concern-usage) (viewpoint-usage))))
)
~~~
