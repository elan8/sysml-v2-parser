...
(fixture-diagnostics
  (document "28_individuals_and_roles_1.md"
    (diagnostics
      (diagnostic (code "unexpected_keyword_in_scope") (severity error) (category parseerror) (span (offset 395) (line 18) (column 3) (len 101)) (message "unexpected keyword `then` in part usage body"))
    )
  )
)
~~~
