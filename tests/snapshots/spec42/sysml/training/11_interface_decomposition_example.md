...
(parsed-document
  ...
  (root (package (name "Interface Decomposition Example") (body (port-def (name "SpigotBank") (specializes none) (body semicolon)) (port-def (name "Spigot") (specializes none) (body semicolon)) (port-def (name "Faucet") (specializes none) (body semicolon)) (port-def (name "FaucetInlet") (specializes none) (body semicolon)) (interface-def))))
)
~~~
