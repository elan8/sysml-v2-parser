...
(parsed-document
  ...
  (root (package (name "Merge Example") (body brace (part-def (name "Scene") (body semicolon)) (part-def (name "Image") (body semicolon)) (part-def (name "Picture") (body semicolon)) (action-def (name "Focus") (specializes none) (body brace (item-usage) (item-usage))) (action-def (name "Shoot") (specializes none) (body brace (item-usage) (item-usage))) (action-def (name "Display") (specializes none) (body brace (item-usage))) (action-def (name "TakePicture") (specializes none) (body semicolon)) (action-usage (name "takePicture") (short-name none)))))
)
~~~
