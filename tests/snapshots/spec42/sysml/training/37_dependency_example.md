...
(parsed-document
  ...
  (root (package (name "Dependency Example") (body brace (part-usage (declaration-name "System Assembly") (typing none) (multiplicity-modifiers (ordered false) (nonunique false)) (body brace (part-usage) (part-usage))) (package (name "Software Design") (body brace (item-def) (item-def))) (dependency (clients (ref r0)) (suppliers (ref r1)) (body semicolon)) (dependency (clients (ref r2)) (suppliers (ref r3) (ref r4)) (body semicolon)))))
)
~~~
