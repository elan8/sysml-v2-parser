...
(parsed-document
  ...
  (root (package (name "State Definition Example-1") (body (attribute-def) (attribute-def) (attribute-def) (state-def (name "VehicleStates") (body (entry (action-keyword false) (target none) (body semicolon)) (then (state (ref r0))) (state-usage) (transition) (state-usage) (transition) (state-usage) (transition))))))
)
~~~
