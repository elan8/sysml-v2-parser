...
(parsed-document
  ...
  (root (package (name "Documentation Example") (body brace (doc (name none) (locale none) (body (span (offset 41) (line 2) (column 8) (len 61)) (normalized "This is documentation of the owning \npackage.\n"))) (part-def (name "Automobile") (body brace (doc (name "Document1") (locale none) (body (span (offset 148) (line 7) (column 19) (len 35)) (normalized "This documentation of Automobile. "))))) (alias (name "Car") (target (ref r0)) (body brace (element-count 1))) (alias (name "Torque") (target (ref r1)) (body semicolon)))))
)
~~~
