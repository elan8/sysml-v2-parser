...
(parsed-document
  ...
  (root (package (name "Use Case Definition Example") (body brace (part-def (name "Vehicle") (body semicolon)) (part-def (name "Person") (body semicolon)) (part-def (name "Environment") (body semicolon)) (part-def (name "Fuel Station") (body semicolon)) (use-case-def (name "Provide Transportation") (body brace (subject) (actor (name "driver") (short-name none) (type (ref r0)) (multiplicity none)) (actor (name "passengers") (short-name none) (type (ref r1)) (multiplicity (lower (expression (span (offset 256) (line 12) (column 29) (len 1)) (integer 0))) (upper (expression (span (offset 259) (line 12) (column 32) (len 1)) (integer 4))))) (actor (name "environment") (short-name none) (type (ref r2)) (multiplicity none)) (objective))) (use-case-def (name "Enter Vehicle") (body brace (subject) (actor (name "driver") (short-name none) (type (ref r3)) (multiplicity none)) (actor (name "passengers") (short-name none) (type (ref r4)) (multiplicity (lower (expression (span (offset 543) (line 26) (column 29) (len 1)) (integer 0))) (upper (expression (span (offset 546) (line 26) (column 32) (len 1)) (integer 4))))))) (use-case-def (name "Exit Vehicle") (body brace (subject) (actor (name "driver") (short-name none) (type (ref r5)) (multiplicity none)) (actor (name "passengers") (short-name none) (type (ref r6)) (multiplicity (lower (expression (span (offset 668) (line 32) (column 29) (len 1)) (integer 0))) (upper (expression (span (offset 671) (line 32) (column 32) (len 1)) (integer 4))))))))))
)
~~~
