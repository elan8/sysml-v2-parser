...
(parsed-document
  ...
  (root (package (name "Use Case Definition Example") (body brace (part-def (name "Vehicle") (body semicolon)) (part-def (name "Person") (body semicolon)) (part-def (name "Environment") (body semicolon)) (part-def (name "Fuel Station") (body semicolon)) (use-case-def (name "Provide Transportation") (body brace (subject) (actor (name "driver") (type (ref r0))) (actor (name "passengers") (type (ref r1))) (actor (name "environment") (type (ref r2))) (objective))) (use-case-def (name "Enter Vehicle") (body brace (subject) (actor (name "driver") (type (ref r3))) (actor (name "passengers") (type (ref r4))))) (use-case-def (name "Exit Vehicle") (body brace (subject) (actor (name "driver") (type (ref r5))) (actor (name "passengers") (type (ref r6))))))))
)
~~~
