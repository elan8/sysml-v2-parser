...
(fixture-diagnostics
  (document "server_sequence_realization_2.md"
    (diagnostics
      (diagnostic (code "recovered_definition_body_element") (severity error) (category parseerror) (span (offset 2242) (line 80) (column 5) (len 49)) (message "unexpected token in definition body"))
      (diagnostic (code "recovery_cascade_suppressed") (severity warning) (category parseerror) (span (offset 2242) (line 80) (column 5) (len 49)) (message "suppressed 5 cascading recovered diagnostics after earlier recovery errors"))
    )
  )
)
~~~
