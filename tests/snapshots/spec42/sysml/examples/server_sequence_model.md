...
(parsed-document
  ...
  (root (package (name "ServerSequenceModel") (body (import (target (span (span (offset 46) (line 2) (column 17) (len 20))) (all none) (ref r0) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 83) (line 3) (column 16) (len 20))) (all none) (ref r1) (shape (namespace (wildcard-suffix (span (span (offset 100) (line 3) (column 33) (len 3))) (separator (span (offset 100) (line 3) (column 33) (len 2))) (marker (span (offset 102) (line 3) (column 35) (len 1)))) (recursive-suffix none) (combined-recursive-suffix-span none))))) (package (name "SignalDefinitions") (body (item-def) (item-def) (item-def))) (part-def (name "PubSubSequence") (body (part-usage) (flow-usage) (part-usage) (flow-usage) (flow-usage) (part-usage))))))
)
~~~
