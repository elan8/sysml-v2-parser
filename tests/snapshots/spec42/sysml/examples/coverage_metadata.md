...
(parsed-document
  ...
  (root (metadata-def (name "Classified") (abstract false) (specializes none) (body semicolon)) (metadata-def (name "Approval") (abstract false) (specializes none) (body semicolon)) (package (name "Annotated") (body brace (metadata-annotation (prefixes) (introducer at) (declared-name none) (type (ref r0)) (about (ref r1)) (body semicolon)) (part-def (name "Vehicle") (body semicolon)) (part-def (name "Engine") (body semicolon)) (metadata-usage (declaration-name "m") (type (ref r2)) (about (ref r3) (ref r4)) (body semicolon)) (metadata-keyword-usage (type (ref r5)) (body none)) (part-def (name "AnnotatedPart") (body semicolon)) (metadata-keyword-usage (type (ref r6)) (body none)) (metadata-keyword-usage (type (ref r7)) (body none)) (part-def (name "MultiAnnotated") (body semicolon)))))
)
~~~
