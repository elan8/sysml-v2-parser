...
(fixture-diagnostics
  (document "conjugation_test.md"
    (diagnostics
      (diagnostic (code "recovered_interface_usage_body_element") (severity error) (category parseerror) (span (offset 370) (line 30) (column 4) (len 28)) (message "unexpected token in interface usage body"))
      (diagnostic (code "recovery_cascade_suppressed") (severity warning) (category parseerror) (span (offset 370) (line 30) (column 4) (len 28)) (message "suppressed 1 cascading recovered diagnostic after earlier recovery errors"))
    )
  )
)
~~~
