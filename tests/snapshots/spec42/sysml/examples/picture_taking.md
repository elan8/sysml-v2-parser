...
(parsed-document
  ...
  (root (package (name "PictureTaking") (body (part-def (name "Exposure") (body semicolon)) (action-def (name "Focus") (specializes none) (body (in-out (direction out) (reference false) (declaration "xrsl") (type (ref r0)) (multiplicity none) (redefines none) (value none) (span (offset 66) (line 4) (column 21) (len 19))))) (action-def (name "Shoot") (specializes none) (body (in-out (direction in) (reference false) (declaration "xsf") (type (ref r1)) (multiplicity none) (redefines none) (value none) (span (offset 108) (line 5) (column 21) (len 17))))) (action-usage))))
)
~~~
