...
(parsed-document
  ...
  (root (package (name "IssueMetadataExample") (body brace (import (target (span (span (offset 47) (line 2) (column 17) (len 23))) (all none) (ref r0) (shape (membership (recursive-suffix none))))) (metadata-usage) (interface-def (name "EngineToTransmissionInterface") (specializes none) (body brace (end (identity (declaration (name "p1") (span (offset 730) (line 14) (column 13) (len 2)))) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r1)))) (references none) (redefines none) (crosses none)) (end (identity (declaration (name "p2") (span (offset 759) (line 15) (column 13) (len 2)))) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r2)))) (references none) (redefines none) (crosses none)))) (port-def (name "DrivePwrPort") (specializes none) (body semicolon)) (port-def (name "ClutchPort") (specializes none) (body semicolon)) (part-usage (declaration-name "engine") (typing none) (body brace (port-usage))) (part-usage (declaration-name "transmission") (typing none) (body brace (port-usage))) (interface-usage))))
)
~~~
