...
(fixture-diagnostics
  (document "room_model.md"
    (diagnostics
      (diagnostic (code "recovered_port_def_body_element") (severity error) (category parseerror) (span (offset 849) (line 23) (column 17) (len 40)) (message "unexpected token in port definition body"))
      (diagnostic (code "recovery_cascade_suppressed") (severity warning) (category parseerror) (span (offset 849) (line 23) (column 17) (len 40)) (message "suppressed 5 cascading recovered diagnostics after earlier recovery errors"))
    )
  )
)
~~~
