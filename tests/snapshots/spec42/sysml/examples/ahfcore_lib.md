...
(fixture-diagnostics
  (document "ahfcore_lib.md"
    (diagnostics
      (diagnostic (code "unrecognized_declaration_in_scope") (severity error) (category parseerror) (span (offset 583) (line 23) (column 11) (len 982)) (message "unrecognized declaration `ArrowheadCore` in package body"))
    )
  )
)
~~~
