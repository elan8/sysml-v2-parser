...
(parsed-document
  ...
  (root (package (name "ExtendedExamples") (body brace (extended-def (prefix-keywords ((ref r0))) (definition-prefix none) (def true) (name "Failure") (specializes none) (body semicolon)) (extended-def (prefix-keywords ((ref r1))) (definition-prefix none) (def true) (name "Failure") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r2)))) (body semicolon)) (extended-def (prefix-keywords ((ref r3))) (definition-prefix abstract) (def true) (name "AbstractFailure") (specializes none) (body semicolon)) (extended-def (prefix-keywords ((ref r4) (ref r5))) (definition-prefix none) (def true) (name "Vulnerability") (specializes none) (body semicolon)) (extended-def (prefix-keywords ((ref r6))) (definition-prefix none) (def true) (name "Failure") (specializes none) (body brace (part-usage (declaration-name "p") (typing none) (multiplicity-modifiers (ordered false) (nonunique false)) (body semicolon)))) (extended-def (prefix-keywords ((ref r7))) (definition-prefix none) (def false) (name "batteryLow") (specializes none) (body semicolon)) (metadata-keyword-usage (type (ref r8)) (body none)) (default-reference-usage) (metadata-keyword-usage (type (ref r9)) (body none)) (malformed (code "unrecognized_declaration_in_scope") (found "x : T { }") (span (offset 290) (line 9) (column 16) (len 14))) (extended-def (prefix-keywords ((ref r10))) (definition-prefix variation) (def true) (name "V") (specializes none) (body semicolon)))))
)
~~~
