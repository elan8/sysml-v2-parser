...
(parsed-document
  ...
  (root (package (name "P") (body (action-def (name "A") (specializes none) (body (malformed (code "recovered_action_body_element") (found "for") (span (offset 31) (line 3) (column 5) (len 83))) (action-usage (declaration "send") (type none)))))))
)
~~~
