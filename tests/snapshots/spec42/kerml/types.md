...
(parsed-document
  (references
    ...
    (reference r5 (scope relative) (span (offset 354) (line 15) (column 12) (len 14)) (segments (segment 0 (token "Base") (name "Base") (separator none) (span (offset 354) (line 15) (column 12) (len 4))) (segment 1 (token "Anything") (name "Anything") (separator colon-colon) (span (offset 360) (line 15) (column 18) (len 8)))))
    (reference r6 (scope relative) (span (offset 400) (line 17) (column 29) (len 1)) (segments (segment 0 (token "A") (name "A") (separator none) (span (offset 400) (line 17) (column 29) (len 1)))))
    (reference r7 (scope relative) (span (offset 414) (line 17) (column 43) (len 1)) (segments (segment 0 (token "B") (name "B") (separator none) (span (offset 414) (line 17) (column 43) (len 1)))))
  )
  (root (package (name "Types") (body (kerml-classifier (keyword type) (abstract true) (name "A") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r0))))) (kerml-classifier (keyword type) (abstract false) (name "x") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r1) (ref r2))))) (kerml-classifier (keyword type) (abstract false) (name "Singleton") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r3))))) (kerml-classifier (keyword type) (abstract false) (name "Super") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r4))))) (kerml-classifier (keyword type) (abstract false) (name "B") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r5))))) (kerml-relationship (keyword subtype) (source (ref r6)) (target (ref r7))) (malformed (code "unrecognized_declaration_in_scope") (found "specialization subtype x :> Base::things;") (span (offset 418) (line 18) (column 2) (len 545))))))
)
~~~
