...
(fixture-diagnostics
  (document "expressions.md"
    (diagnostics
      (diagnostic (code "unrecognized_declaration_in_scope") (severity error) (category parseerror) (span (offset 139) (line 6) (column 2) (len 1669)) (message "unrecognized declaration `a` in package body"))
    )
  )
)
~~~
