...
(parsed-document
  ...
  (root (package (name "Foo") (body (malformed (code "recovered_package_body_element") (found "+ bad stuff;") (span (offset 18) (line 2) (column 5) (len 17))) (part-def (name "Bar") (body semicolon)))))
)
~~~
