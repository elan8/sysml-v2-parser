...
(parsed-document
  (references
    (reference r0 (scope relative) (span (offset 105) (line 3) (column 58) (len 11)) (segments (segment 0 (token "things") (name "things") (separator none) (span (offset 105) (line 3) (column 58) (len 6))) (segment 1 (token "that") (name "that") (separator dot) (span (offset 112) (line 3) (column 65) (len 4)))))
    (reference r1 (scope relative) (span (offset 255) (line 8) (column 33) (len 4)) (segments (segment 0 (token "Real") (name "Real") (separator none) (span (offset 255) (line 8) (column 33) (len 4)))))
    (reference r2 (scope relative) (span (offset 410) (line 15) (column 14) (len 4)) (segments (segment 0 (token "that") (name "that") (separator none) (span (offset 410) (line 15) (column 14) (len 4)))))
    (reference r3 (scope relative) (span (offset 418) (line 15) (column 22) (len 10)) (segments (segment 0 (token "Occurrence") (name "Occurrence") (separator none) (span (offset 418) (line 15) (column 22) (len 10)))))
    (reference r4 (scope relative) (span (offset 430) (line 15) (column 34) (len 6)) (segments (segment 0 (token "member") (name "member") (separator none) (span (offset 430) (line 15) (column 34) (len 6)))))
  )
  (root (package (name "ThatSelfReference") (body brace (kerml-classifier (keyword type) (abstract false) (name "Anything") (specializes none) (body brace (kerml-feature (name "self") (relationships (chains (ref r0))) (value none) (body semicolon)))) (kerml-feature (name "things") (relationships) (value none) (body brace (kerml-feature (name "that") (relationships) (value none) (body semicolon)))) (kerml-classifier (keyword datatype) (abstract false) (name "UnitBoundedReal") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r1)))) (body brace (invariant))) (part-def (name "Occurrences") (modifiers) (body brace (constraint-usage (prefix (direction none) (derived false) (variance none) (constant false) (reference false) (individual false) (portion none) (extensions)) (declaration-name "viaCast") (short-name none) (type none) (multiplicity none) (subsets none) (redefines none) (body brace (expression (span (offset 409) (line 15) (column 13) (len 27)) (member-access (base (expression (span (offset 409) (line 15) (column 13) (len 20)) (sequence (sequence-list (element first (expression (span (offset 410) (line 15) (column 14) (len 18)) (type-check (kind as) (operand (expression (span (offset 410) (line 15) (column 14) (len 4)) (ref r2))) (type (ref r3))))))))) (separator dot) (member (ref r4)))))))))))
)
~~~
