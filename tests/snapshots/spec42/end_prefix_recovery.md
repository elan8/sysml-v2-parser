...
(fixture-diagnostics
  (document "end_prefix_recovery.md"
    (diagnostics
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 76) (line 3) (column 9) (len 37)) (message "`end` feature prefix cannot carry the direction `in`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 187) (line 7) (column 9) (len 37)) (message "`end` feature prefix cannot carry the direction `in`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 294) (line 11) (column 9) (len 37)) (message "`end` feature prefix cannot carry the direction `in`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 513) (line 19) (column 9) (len 49)) (message "`end` feature prefix cannot carry the restriction modifier `derived`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 562) (line 20) (column 9) (len 57)) (message "`end` feature prefix cannot carry the restriction modifier `derived`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 619) (line 21) (column 9) (len 51)) (message "`end` feature prefix cannot carry the restriction modifier `abstract`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 670) (line 22) (column 9) (len 59)) (message "`end` feature prefix cannot carry the restriction modifier `abstract`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 729) (line 23) (column 9) (len 53)) (message "`end` feature prefix cannot carry the restriction modifier `composite`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 782) (line 24) (column 9) (len 61)) (message "`end` feature prefix cannot carry the restriction modifier `composite`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 843) (line 25) (column 9) (len 49)) (message "`end` feature prefix cannot carry the restriction modifier `portion`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 892) (line 26) (column 9) (len 57)) (message "`end` feature prefix cannot carry the restriction modifier `portion`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 949) (line 27) (column 9) (len 41)) (message "`end` feature prefix cannot carry the restriction modifier `var`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
      (diagnostic (code "end_feature_invalid_prefix") (severity error) (category parseerror) (span (offset 990) (line 28) (column 9) (len 49)) (message "`end` feature prefix cannot carry the restriction modifier `var`: `EndFeaturePrefix` (KerML BNF 573) admits only `const`"))
    )
  )
)
~~~
