...
(parsed-document
  ...
  (root (library-package (name "Connections") (standard true) (body brace (doc (name none) (locale none) (body (span (offset 53) (line 3) (column 7) (len 128)) (normalized "This package defines the base types for connections and related structural elements \nin the SysML language.\n"))) (import (target (span (span (offset 204) (line 8) (column 20) (len 14))) (all none) (ref r0) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 239) (line 9) (column 20) (len 23))) (all none) (ref r1) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 283) (line 10) (column 20) (len 26))) (all none) (ref r2) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 330) (line 11) (column 20) (len 19))) (all none) (ref r3) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 370) (line 12) (column 20) (len 20))) (all none) (ref r4) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 411) (line 13) (column 20) (len 25))) (all none) (ref r5) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 457) (line 14) (column 20) (len 26))) (all none) (ref r6) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 504) (line 15) (column 20) (len 19))) (all none) (ref r7) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 544) (line 16) (column 20) (len 20))) (all none) (ref r8) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 585) (line 17) (column 20) (len 23))) (all none) (ref r9) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 629) (line 18) (column 20) (len 24))) (all none) (ref r10) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 674) (line 19) (column 20) (len 29))) (all none) (ref r11) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 724) (line 20) (column 20) (len 30))) (all none) (ref r12) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 775) (line 21) (column 20) (len 21))) (all none) (ref r13) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 817) (line 22) (column 20) (len 11))) (all none) (ref r14) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 849) (line 23) (column 20) (len 12))) (all none) (ref r15) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 882) (line 24) (column 20) (len 15))) (all none) (ref r16) (shape (membership (recursive-suffix none))))) (import (target (span (span (offset 918) (line 25) (column 20) (len 16))) (all none) (ref r17) (shape (membership (recursive-suffix none))))) (connection-def (name "Connection") (modifiers (abstract (span (offset 941) (line 27) (column 5) (len 8)))) (role ordinary) (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r18) (ref r19)))) (body brace (doc (name none) (locale none) (body (span (offset 1020) (line 29) (column 11) (len 186)) (normalized "Connection is the most general class of links between things within some \ncontaining structure. Connection is the base type of all ConnectionDefinitions.\n"))))) (connection-def (name "BinaryConnection") (modifiers (abstract (span (offset 1225) (line 35) (column 5) (len 8)))) (role ordinary) (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r20) (ref r21)))) (body brace (doc (name none) (locale none) (body (span (offset 1322) (line 37) (column 11) (len 243)) (normalized "BinaryConnection is the most general class of binary links between two things \nwithin some containing structure. BinaryConnection is the base type of all \nConnectionDefinitions with exactly two ends.\n"))) (end (prefix (direction none) (derived false) (constant false) (variance none)) (introducer bare) (short-name none) (identity (declaration (name "source") (span (offset 1585) (line 43) (column 13) (len 6)))) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r22)))) (references none) (multiplicity none) (redefines (relationship (kind redefines) (implied false) (targets (ref r23)))) (crosses none) (nested-usage none)) (end (prefix (direction none) (derived false) (constant false) (variance none)) (introducer bare) (short-name none) (identity (declaration (name "target") (span (offset 1644) (line 44) (column 13) (len 6)))) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r24)))) (references none) (multiplicity none) (redefines (relationship (kind redefines) (implied false) (targets (ref r25)))) (crosses none) (nested-usage none)))) (connection-def (name "connections") (modifiers (abstract (span (offset 1706) (line 47) (column 5) (len 8)))) (role ordinary) (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r26) (ref r27)))) (body brace (doc (name none) (locale none) (body (span (offset 1812) (line 49) (column 11) (len 78)) (normalized "connections is the base feature of all ConnectionUsages.\n"))))) (connection-def (name "binaryConnections") (modifiers (abstract (span (offset 1908) (line 54) (column 5) (len 8)))) (role ordinary) (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r28) (ref r29)))) (body brace (doc (name none) (locale none) (body (span (offset 2032) (line 56) (column 11) (len 91)) (normalized "binaryConnections is the base feature of all binary ConnectionUsages.\n"))))))))
)
~~~
