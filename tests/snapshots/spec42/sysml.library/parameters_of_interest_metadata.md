...
(parsed-document
  ...
  (root (library-package (name "ParametersOfInterestMetadata") (standard true) (body brace (doc) (import (target (span (span (offset 271) (line 8) (column 18) (len 29))) (all none) (ref r0) (shape (membership (recursive-suffix none))))) (attribute-def (name "measuresOfEffectiveness") (multiplicity (lower unbounded) (upper unbounded))) (attribute-def (name "measuresOfPerformance") (multiplicity (lower unbounded) (upper unbounded))) (metadata-def) (metadata-def))))
)
~~~
