...
(parsed-document
  ...
  (root (library-package (name "ImageMetadata") (standard true) (body (doc) (import (target (span (span (offset 288) (line 9) (column 17) (len 20))) (all none) (ref r0) (shape (membership (recursive-suffix none))))) (attribute-def) (metadata-def))))
)
~~~
