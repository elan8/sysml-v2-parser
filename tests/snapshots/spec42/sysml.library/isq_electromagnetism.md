# META
~~~sexpr
(snapshot (type semantic) (description "Standard Library: Domain Libraries/Quantities and Units/ISQElectromagnetism"))
~~~
# SOURCE
~~~sysml
...
~~~sexpr
(fixture-diagnostics
  (document "isq_electromagnetism.md"
    (diagnostics
    )
  )
)
...
standard library package ISQElectromagnetism {
    ...
    attribute def relativePermittivity : RelativePermittivityValue;
    attribute def ElectricSusceptibilityValue :> DimensionOneValue {
        doc
        /*
         * source: item 6-16 electric susceptibility
    ...
    attribute def electricSusceptibility : ElectricSusceptibilityValue;
    attribute def ElectricFluxValue :> ScalarQuantityValue {
        doc
        /*
         * source: item 6-17 electric flux
    ...
    attribute def totalCurrent : ElectricCurrentValue {
        doc
        /*
         * source: item 6-19.2 total current
         * symbol(s): `I_"tot"`, `I_t`
    ...
    attribute def relativePermeability : RelativePermeabilityValue;
    attribute def MagneticSusceptibilityValue :> DimensionOneValue {
        doc
        /*
         * source: item 6-28 magnetic susceptibility
    ...
    attribute def magneticSusceptibility : MagneticSusceptibilityValue;
    attribute def MagneticPolarizationValue :> ScalarQuantityValue {
        doc
        /*
         * source: item 6-29 magnetic polarization (magnitude)
    ...
    alias SourceTensionValue for SourceVoltageValue;
    alias sourceTension for sourceVoltage;
    attribute def scalarMagneticPotential : ElectricCurrentValue {
        doc
        /*
         * source: item 6-37.1 scalar magnetic potential
         * symbol(s): `V_m`, `φ`
    ...
    attribute def magneticTension : ElectricCurrentValue {
        doc
        /*
         * source: item 6-37.2 magnetic tension
         * symbol(s): `U_m`
    ...
    attribute def numberOfTurnsInAWinding : CountValue {
        doc
        /*
         * source: item 6-38 number of turns in a winding
         * symbol(s): `N`
    ...
    alias SelfInductanceValue for InductanceValue;
    alias selfInductance for inductance;
    attribute def mutualInductance : InductanceValue {
        doc
        /*
         * source: item 6-41.2 mutual inductance
         * symbol(s): `L_(mn)`
    ...
    attribute def couplingFactor : CouplingFactorValue;
    attribute def LeakageFactorValue :> DimensionOneValue {
        doc
        /*
         * source: item 6-42.2 leakage factor
    ...
    attribute def leakageFactor : LeakageFactorValue;
    attribute def ConductivityValue :> ScalarQuantityValue {
        doc
        /*
         * source: item 6-43 conductivity
    ...
    attribute def voltagePhasor : ElectricPotentialDifferenceValue {
        doc
        /*
         * source: item 6-50 voltage phasor
         * symbol(s): `underline(U)`
    ...
    alias ComplexAdmittanceValue for AdmittanceValue;
    alias complexAdmittance for admittance;
    attribute def conductanceForAlternatingCurrent : ConductanceValue {
        doc
        /*
         * source: item 6-52.2 conductance for alternating current
         * symbol(s): `G`
    ...
    attribute def qualityFactor : QualityFactorValue;
    attribute def LossFactorValue :> DimensionOneValue {
        doc
        /*
         * source: item 6-54 loss factor
    ...
    attribute def lossFactor : LossFactorValue;
    attribute def lossAngle : AngularMeasureValue {
        doc
        /*
         * source: item 6-55 loss angle
         * symbol(s): `δ`
    ...
    attribute def activePower : PowerValue {
        doc
        /*
         * source: item 6-56 active power
         * symbol(s): `P`
    ...
    attribute def apparentPower : PowerValue {
        doc
        /*
         * source: item 6-57 apparent power
         * symbol(s): ``, `underline(S)`, ``
    ...
    attribute def powerFactor : PowerFactorValue;
    attribute def complexPower : PowerValue {
        doc
        /*
         * source: item 6-59 complex power
         * symbol(s): `underline(S)`
    ...
    attribute def reactivePower : PowerValue {
        doc
        /*
         * source: item 6-60 reactive power
         * symbol(s): `Q`
    ...
    attribute def nonActivePower : PowerValue {
        doc
        /*
         * source: item 6-61 non-active power
         * symbol(s): `Q'`
    ...
    attribute def activeEnergy : EnergyValue {
        doc
        /*
         * source: item 6-62 active energy
         * symbol(s): `W`
...
(parsed-document
  (references
    (reference r0 (scope relative) (span (offset 816) (line 15) (column 20) (len 18)) (segments (segment 0 (token "ScalarValues") (name "ScalarValues") (separator none) (span (offset 816) (line 15) (column 20) (len 12))) (segment 1 (token "Real") (name "Real") (separator colon-colon) (span (offset 830) (line 15) (column 34) (len 4)))))
    (reference r1 (scope relative) (span (offset 855) (line 16) (column 20) (len 10)) (segments (segment 0 (token "Quantities") (name "Quantities") (separator none) (span (offset 855) (line 16) (column 20) (len 10)))))
    (reference r2 (scope relative) (span (offset 889) (line 17) (column 20) (len 21)) (segments (segment 0 (token "MeasurementReferences") (name "MeasurementReferences") (separator none) (span (offset 889) (line 17) (column 20) (len 21)))))
    (reference r3 (scope relative) (span (offset 934) (line 18) (column 20) (len 7)) (segments (segment 0 (token "ISQBase") (name "ISQBase") (separator none) (span (offset 934) (line 18) (column 20) (len 7)))))
    (reference r4 (scope relative) (span (offset 1032) (line 21) (column 20) (len 24)) (segments (segment 0 (token "ISQMechanics") (name "ISQMechanics") (separator none) (span (offset 1032) (line 21) (column 20) (len 12))) (segment 1 (token "PowerValue") (name "PowerValue") (separator colon-colon) (span (offset 1046) (line 21) (column 34) (len 10)))))
    (reference r5 (scope relative) (span (offset 1077) (line 22) (column 20) (len 33)) (segments (segment 0 (token "ISQSpaceTime") (name "ISQSpaceTime") (separator none) (span (offset 1077) (line 22) (column 20) (len 12))) (segment 1 (token "AngularMeasureValue") (name "AngularMeasureValue") (separator colon-colon) (span (offset 1091) (line 22) (column 34) (len 19)))))
    (reference r6 (scope relative) (span (offset 1131) (line 23) (column 20) (len 30)) (segments (segment 0 (token "ISQThermodynamics") (name "ISQThermodynamics") (separator none) (span (offset 1131) (line 23) (column 20) (len 17))) (segment 1 (token "EnergyValue") (name "EnergyValue") (separator colon-colon) (span (offset 1150) (line 23) (column 39) (len 11)))))
    (reference r7 (scope relative) (span (offset 4115) (line 81) (column 41) (len 25)) (segments (segment 0 (token "ElectricChargeDensityUnit") (name "ElectricChargeDensityUnit") (separator none) (span (offset 4115) (line 81) (column 41) (len 25)))))
    (reference r8 (scope relative) (span (offset 4183) (line 82) (column 42) (len 26)) (segments (segment 0 (token "ElectricChargeDensityValue") (name "ElectricChargeDensityValue") (separator none) (span (offset 4183) (line 82) (column 42) (len 26)))))
    (reference r9 (scope relative) (span (offset 4247) (line 83) (column 37) (len 21)) (segments (segment 0 (token "electricChargeDensity") (name "electricChargeDensity") (separator none) (span (offset 4247) (line 83) (column 37) (len 21)))))
    (reference r10 (scope relative) (span (offset 5746) (line 112) (column 39) (len 34)) (segments (segment 0 (token "SurfaceDensityOfElectricChargeUnit") (name "SurfaceDensityOfElectricChargeUnit") (separator none) (span (offset 5746) (line 112) (column 39) (len 34)))))
    (reference r11 (scope relative) (span (offset 5821) (line 113) (column 40) (len 35)) (segments (segment 0 (token "SurfaceDensityOfElectricChargeValue") (name "SurfaceDensityOfElectricChargeValue") (separator none) (span (offset 5821) (line 113) (column 40) (len 35)))))
    (reference r12 (scope relative) (span (offset 5892) (line 114) (column 35) (len 30)) (segments (segment 0 (token "surfaceDensityOfElectricCharge") (name "surfaceDensityOfElectricCharge") (separator none) (span (offset 5892) (line 114) (column 35) (len 30)))))
    (reference r13 (scope relative) (span (offset 7393) (line 143) (column 40) (len 33)) (segments (segment 0 (token "LinearDensityOfElectricChargeUnit") (name "LinearDensityOfElectricChargeUnit") (separator none) (span (offset 7393) (line 143) (column 40) (len 33)))))
    (reference r14 (scope relative) (span (offset 7468) (line 144) (column 41) (len 34)) (segments (segment 0 (token "LinearDensityOfElectricChargeValue") (name "LinearDensityOfElectricChargeValue") (separator none) (span (offset 7468) (line 144) (column 41) (len 34)))))
    (reference r15 (scope relative) (span (offset 7539) (line 145) (column 36) (len 29)) (segments (segment 0 (token "linearDensityOfElectricCharge") (name "linearDensityOfElectricCharge") (separator none) (span (offset 7539) (line 145) (column 36) (len 29)))))
    (reference r16 (scope relative) (span (offset 15590) (line 302) (column 62) (len 48)) (segments (segment 0 (token "CartesianElectricCurrentDensity3dCoordinateFrame") (name "CartesianElectricCurrentDensity3dCoordinateFrame") (separator none) (span (offset 15590) (line 302) (column 62) (len 48)))))
    (reference r17 (scope relative) (span (offset 15692) (line 303) (column 53) (len 39)) (segments (segment 0 (token "cartesianElectricCurrentDensity3dVector") (name "cartesianElectricCurrentDensity3dVector") (separator none) (span (offset 15692) (line 303) (column 53) (len 39)))))
    (reference r18 (scope relative) (span (offset 18836) (line 356) (column 63) (len 54)) (segments (segment 0 (token "CartesianLinearElectricCurrentDensity3dCoordinateFrame") (name "CartesianLinearElectricCurrentDensity3dCoordinateFrame") (separator none) (span (offset 18836) (line 356) (column 63) (len 54)))))
    (reference r19 (scope relative) (span (offset 18945) (line 357) (column 54) (len 45)) (segments (segment 0 (token "cartesianLinearElectricCurrentDensity3dVector") (name "cartesianLinearElectricCurrentDensity3dVector") (separator none) (span (offset 18945) (line 357) (column 54) (len 45)))))
    (reference r20 (scope relative) (span (offset 26098) (line 484) (column 31) (len 7)) (segments (segment 0 (token "voltage") (name "voltage") (separator none) (span (offset 26098) (line 484) (column 31) (len 7)))))
    (reference r21 (scope relative) (span (offset 29048) (line 538) (column 62) (len 45)) (segments (segment 0 (token "CartesianElectricFluxDensity3dCoordinateFrame") (name "CartesianElectricFluxDensity3dCoordinateFrame") (separator none) (span (offset 29048) (line 538) (column 62) (len 45)))))
    (reference r22 (scope relative) (span (offset 29147) (line 539) (column 53) (len 36)) (segments (segment 0 (token "cartesianElectricFluxDensity3dVector") (name "cartesianElectricFluxDensity3dVector") (separator none) (span (offset 29147) (line 539) (column 53) (len 36)))))
    (reference r23 (scope relative) (span (offset 32024) (line 597) (column 40) (len 20)) (segments (segment 0 (token "ElectricConstantUnit") (name "ElectricConstantUnit") (separator none) (span (offset 32024) (line 597) (column 40) (len 20)))))
    (reference r24 (scope relative) (span (offset 32086) (line 598) (column 41) (len 21)) (segments (segment 0 (token "ElectricConstantValue") (name "ElectricConstantValue") (separator none) (span (offset 32086) (line 598) (column 41) (len 21)))))
    (reference r25 (scope relative) (span (offset 32144) (line 599) (column 36) (len 16)) (segments (segment 0 (token "electricConstant") (name "electricConstant") (separator none) (span (offset 32144) (line 599) (column 36) (len 16)))))
    (reference r26 (scope relative) (span (offset 50873) (line 982) (column 60) (len 40)) (segments (segment 0 (token "CartesianMagneticMoment3dCoordinateFrame") (name "CartesianMagneticMoment3dCoordinateFrame") (separator none) (span (offset 50873) (line 982) (column 60) (len 40)))))
    (reference r27 (scope relative) (span (offset 50965) (line 983) (column 51) (len 31)) (segments (segment 0 (token "cartesianMagneticMoment3dVector") (name "cartesianMagneticMoment3dVector") (separator none) (span (offset 50965) (line 983) (column 51) (len 31)))))
    (reference r28 (scope relative) (span (offset 55984) (line 1087) (column 58) (len 47)) (segments (segment 0 (token "CartesianMagneticFieldStrength3dCoordinateFrame") (name "CartesianMagneticFieldStrength3dCoordinateFrame") (separator none) (span (offset 55984) (line 1087) (column 58) (len 47)))))
    (reference r29 (scope relative) (span (offset 56081) (line 1088) (column 49) (len 38)) (segments (segment 0 (token "cartesianMagneticFieldStrength3dVector") (name "cartesianMagneticFieldStrength3dVector") (separator none) (span (offset 56081) (line 1088) (column 49) (len 38)))))
    (reference r30 (scope relative) (span (offset 57596) (line 1118) (column 40) (len 20)) (segments (segment 0 (token "MagneticConstantUnit") (name "MagneticConstantUnit") (separator none) (span (offset 57596) (line 1118) (column 40) (len 20)))))
    (reference r31 (scope relative) (span (offset 57658) (line 1119) (column 41) (len 21)) (segments (segment 0 (token "MagneticConstantValue") (name "MagneticConstantValue") (separator none) (span (offset 57658) (line 1119) (column 41) (len 21)))))
    (reference r32 (scope relative) (span (offset 57716) (line 1120) (column 36) (len 16)) (segments (segment 0 (token "magneticConstant") (name "magneticConstant") (separator none) (span (offset 57716) (line 1120) (column 36) (len 16)))))
    (reference r33 (scope relative) (span (offset 71281) (line 1395) (column 48) (len 32)) (segments (segment 0 (token "ElectromagneticEnergyDensityUnit") (name "ElectromagneticEnergyDensityUnit") (separator none) (span (offset 71281) (line 1395) (column 48) (len 32)))))
    (reference r34 (scope relative) (span (offset 71363) (line 1396) (column 49) (len 33)) (segments (segment 0 (token "ElectromagneticEnergyDensityValue") (name "ElectromagneticEnergyDensityValue") (separator none) (span (offset 71363) (line 1396) (column 49) (len 33)))))
    (reference r35 (scope relative) (span (offset 71441) (line 1397) (column 44) (len 28)) (segments (segment 0 (token "electromagneticEnergyDensity") (name "electromagneticEnergyDensity") (separator none) (span (offset 71441) (line 1397) (column 44) (len 28)))))
    (reference r36 (scope relative) (span (offset 76165) (line 1502) (column 30) (len 16)) (segments (segment 0 (token "SpeedOfLightUnit") (name "SpeedOfLightUnit") (separator none) (span (offset 76165) (line 1502) (column 30) (len 16)))))
    (reference r37 (scope relative) (span (offset 76213) (line 1503) (column 31) (len 17)) (segments (segment 0 (token "SpeedOfLightValue") (name "SpeedOfLightValue") (separator none) (span (offset 76213) (line 1503) (column 31) (len 17)))))
    (reference r38 (scope relative) (span (offset 76257) (line 1504) (column 26) (len 12)) (segments (segment 0 (token "speedOfLight") (name "speedOfLight") (separator none) (span (offset 76257) (line 1504) (column 26) (len 12)))))
    (reference r39 (scope relative) (span (offset 77811) (line 1534) (column 33) (len 17)) (segments (segment 0 (token "SourceVoltageUnit") (name "SourceVoltageUnit") (separator none) (span (offset 77811) (line 1534) (column 33) (len 17)))))
    (reference r40 (scope relative) (span (offset 77863) (line 1535) (column 34) (len 18)) (segments (segment 0 (token "SourceVoltageValue") (name "SourceVoltageValue") (separator none) (span (offset 77863) (line 1535) (column 34) (len 18)))))
    (reference r41 (scope relative) (span (offset 77911) (line 1536) (column 29) (len 13)) (segments (segment 0 (token "sourceVoltage") (name "sourceVoltage") (separator none) (span (offset 77911) (line 1536) (column 29) (len 13)))))
    (reference r42 (scope relative) (span (offset 86242) (line 1711) (column 34) (len 14)) (segments (segment 0 (token "InductanceUnit") (name "InductanceUnit") (separator none) (span (offset 86242) (line 1711) (column 34) (len 14)))))
    (reference r43 (scope relative) (span (offset 86292) (line 1712) (column 35) (len 15)) (segments (segment 0 (token "InductanceValue") (name "InductanceValue") (separator none) (span (offset 86292) (line 1712) (column 35) (len 15)))))
    (reference r44 (scope relative) (span (offset 86338) (line 1713) (column 30) (len 10)) (segments (segment 0 (token "inductance") (name "inductance") (separator none) (span (offset 86338) (line 1713) (column 30) (len 10)))))
    (reference r45 (scope relative) (span (offset 92062) (line 1837) (column 34) (len 13)) (segments (segment 0 (token "electricPower") (name "electricPower") (separator none) (span (offset 92062) (line 1837) (column 34) (len 13)))))
    (reference r46 (scope relative) (span (offset 99374) (line 1978) (column 36) (len 13)) (segments (segment 0 (token "ImpedanceUnit") (name "ImpedanceUnit") (separator none) (span (offset 99374) (line 1978) (column 36) (len 13)))))
    (reference r47 (scope relative) (span (offset 99425) (line 1979) (column 37) (len 14)) (segments (segment 0 (token "ImpedanceValue") (name "ImpedanceValue") (separator none) (span (offset 99425) (line 1979) (column 37) (len 14)))))
    (reference r48 (scope relative) (span (offset 99472) (line 1980) (column 32) (len 9)) (segments (segment 0 (token "impedance") (name "impedance") (separator none) (span (offset 99472) (line 1980) (column 32) (len 9)))))
    (reference r49 (scope relative) (span (offset 105404) (line 2094) (column 37) (len 14)) (segments (segment 0 (token "AdmittanceUnit") (name "AdmittanceUnit") (separator none) (span (offset 105404) (line 2094) (column 37) (len 14)))))
