...
(parsed-document
  ...
  (root (package (name "M") (body brace (part-def (name "System") (body brace (part-usage) (part-usage) (connect (from (expression (span (offset 54) (line 1) (column 55) (len 1)) (ref r0))) (to (expression (span (offset 59) (line 1) (column 60) (len 1)) (ref r1))) (body semicolon) (subsets none) (redefines none)))))))
)
~~~
