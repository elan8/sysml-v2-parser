...
(parsed-document
  ...
  (root (package (name "DependencyCoverage") (body brace (part-def (name "Source") (modifiers) (body semicolon)) (part-def (name "Target") (modifiers) (body semicolon)) (dependency (clients (ref r0)) (suppliers (ref r1)) (body semicolon)))))
)
~~~
