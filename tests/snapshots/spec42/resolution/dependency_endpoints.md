...
(parsed-document
  ...
  (root (package (name "DependencyCoverage") (body (part-def (name "Source") (body semicolon)) (part-def (name "Target") (body semicolon)) (dependency (clients (ref r0)) (suppliers (ref r1)) (body none)))))
)
~~~
