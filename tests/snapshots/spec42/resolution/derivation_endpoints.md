...
(parsed-document
  ...
  (root (package (name "DerivationCoverage") (body brace (requirement-def (name "ParentRequirement") (body semicolon)) (requirement-def (name "ChildRequirement") (body semicolon)) (connection-def (name none) (role (derivation (span (offset 110) (line 4) (column 5) (len 11)))) (specializes none) (body brace (end (identity (derivation-role (kind original) (span (offset 147) (line 5) (column 13) (len 9)))) (typing none) (references (relationship (kind references) (implied false) (targets (ref r0)))) (redefines none) (crosses none)) (end (identity (derivation-role (kind derive) (span (offset 192) (line 6) (column 13) (len 7)))) (typing none) (references (relationship (kind references) (implied false) (targets (ref r1)))) (redefines none) (crosses none)))))))
)
~~~
