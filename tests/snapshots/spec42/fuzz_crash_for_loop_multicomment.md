...
(parsed-document
  ...
  (root (package (name "P") (body brace (action-def (name "A") (specializes none) (body brace (malformed (code "recovered_action_body_element") (found "for") (span (offset 31) (line 3) (column 5) (len 105))))))))
)
~~~
