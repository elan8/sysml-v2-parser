...
(parsed-document
  ...
  (root (package (name "AnnotatingEnumerationBody") (body brace (enum-def (name "Level") (body brace (doc (name none) (locale none) (body (span (offset 71) (line 3) (column 15) (len 24)) (normalized "enumeration definition "))) (enum-value (name "low") (short-name "lo") (value (feature-value (kind bind) (default false) (expression (expression (span (offset 117) (line 4) (column 20) (len 1)) (integer 1))))) (body semicolon) (span (offset 106) (line 4) (column 9) (len 13))) (comment (keyword (span (offset 128) (line 5) (column 9) (len 7))) (name none) (about) (locale none) (body (span (offset 138) (line 5) (column 19) (len 20)) (normalized "between two values "))) (enum-value (name "medium") (short-name none) (value none) (body semicolon) (span (offset 169) (line 6) (column 9) (len 7))) (textual-rep (name "levelRep") (language "text") (body (span (offset 216) (line 7) (column 40) (len 23)) (normalized "enumeration rendering "))) (metadata-annotation (prefixes) (introducer at) (declared-name none) (type (ref r0)) (about) (body semicolon)) (enum-value (name "high") (short-name none) (value none) (body brace (doc (name none) (locale none) (body (span (offset 294) (line 10) (column 19) (len 25)) (normalized "per-value documentation ")))) (span (offset 269) (line 9) (column 9) (len 62))))))))
)
~~~
