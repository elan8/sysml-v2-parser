...
(parsed-document
  ...
  (root (package (name "CommentKeywordProvenance") (body (comment (keyword (span (offset 39) (line 2) (column 5) (len 7))) (name none) (locale none)) (comment (keyword (span (offset 85) (line 3) (column 5) (len 7))) (name "named") (locale none)) (comment (keyword none) (name none) (locale "en_US")) (comment (keyword (span (offset 183) (line 5) (column 5) (len 7))) (name none) (locale "en_US")))))
)
~~~
