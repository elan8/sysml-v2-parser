...
(parsed-document
  ...
  (root (package (name "CalculationBodyActionMembers") (body brace (calc-def (name "Pipeline") (body brace (in-out-declaration) (first (source (expression (span (offset 97) (line 4) (column 15) (len 5)) (ref r0))) (target none) (body semicolon)) (merge) (decision) (join) (fork) (action-usage (declaration "step") (type none)) (if) (assign) (return-declaration))))))
)
~~~
