...
(parsed-document
  ...
  (root (package (name "RefPrefixCoverage") (body brace (action-def (name "A") (modifiers) (specializes none) (body brace (ref (name "") (short-name none) (prefix (direction none) (derived false) (usage-prefix abstract) (constant false)) (extensions) (kind none) (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (value none) (redefines (relationship (kind redefines) (implied false) (targets (ref r0)))) (subsets none) (body semicolon)) (ref (name "deferred") (short-name none) (prefix (direction none) (derived true) (usage-prefix none) (constant false)) (extensions) (kind action) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r1)))) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (value none) (redefines none) (subsets (relationship (kind subsets) (implied false) (targets (ref r2)))) (body semicolon)) (ref (name "everything") (short-name none) (prefix (direction none) (derived true) (usage-prefix abstract) (constant true)) (extensions) (kind action) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r3)))) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (value none) (redefines none) (subsets none) (body semicolon)) (in-out (direction in) (reference true) (declaration "inbound") (subsets none) (type (ref r4)) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (redefines none) (value none) (span (offset 233) (line 6) (column 9) (len 19))))) (metadata-def (name "M") (abstract false) (specializes none) (body brace (ref (name "receiverArgument") (short-name none) (prefix (direction none) (derived true) (usage-prefix none) (constant false)) (extensions) (kind item) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r5)))) (multiplicity (lower (expression (span (offset 335) (line 9) (column 56) (len 1)) (integer 0))) (upper (expression (span (offset 338) (line 9) (column 59) (len 1)) (integer 1)))) (multiplicity-modifiers (ordering none) (uniqueness none)) (value none) (redefines none) (subsets (relationship (kind subsets) (implied false) (targets (ref r6)))) (body semicolon)) (ref (name "action") (short-name none) (prefix (direction none) (derived true) (usage-prefix none) (constant false)) (extensions) (kind item) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r7)))) (multiplicity (lower (expression (span (offset 417) (line 10) (column 49) (len 1)) (integer 0))) (upper unbounded)) (multiplicity-modifiers (ordering ordered) (uniqueness none)) (value none) (redefines none) (subsets (relationship (kind subsets) (implied false) (targets (ref r8) (ref r9) (ref r10)))) (body semicolon)) (item-usage (prefix (direction none) (derived true) (variance none) (constant false) (reference false) (individual false) (portion none) (extensions)) (declaration "ownedActorParameter") (short-name none) (type (ref r11)) (multiplicity (lower (expression (span (offset 562) (line 11) (column 79) (len 1)) (integer 1))) (upper (expression (span (offset 562) (line 11) (column 79) (len 1)) (integer 1)))) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines (relationship (kind redefines) (implied false) (targets (ref r12)))) (value none) (body semicolon)) (ref (name "everything") (short-name none) (prefix (direction none) (derived true) (usage-prefix abstract) (constant true)) (extensions) (kind item) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r13)))) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (value none) (redefines none) (subsets none) (body semicolon)))) (part-def (name "D") (modifiers) (body brace (item-usage (prefix (direction none) (derived false) (variance none) (constant true) (reference false) (individual false) (portion none) (extensions)) (declaration "constantItem") (short-name none) (type (ref r14)) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (value none) (body semicolon)) (item-usage (prefix (direction none) (derived false) (variance variation) (constant false) (reference false) (individual false) (portion none) (extensions)) (declaration "variationItem") (short-name none) (type (ref r15)) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (value none) (body semicolon)) (attribute-usage (declaration-name "everyAttribute") (direction none) (derived true) (usage-prefix abstract) (constant true) (reference true) (end false) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r16)))) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value none) (body semicolon)) (part-usage (then false) (prefix (direction none) (derived true) (variance abstract) (constant true) (reference true) (individual false) (portion none) (extensions)) (declaration-name "everyPart") (short-name none) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r17)))) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (value none) (body semicolon)))))))
)
~~~
