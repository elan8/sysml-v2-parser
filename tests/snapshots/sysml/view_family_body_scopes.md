...
(parsed-document
  ...
  (root (package (name "ViewFamilyBodyScopes") (body brace (part-def (name "Host") (body brace (view-def) (view (name "summary") (type none) (body brace (doc))) (viewpoint-def) (viewpoint-usage) (rendering-def) (rendering-usage))) (part-usage (declaration-name "host") (typing none) (body brace (view-def) (view (name "nestedSummary") (type none) (body brace (doc))) (viewpoint-def) (viewpoint-usage) (rendering-def) (rendering-usage))))))
)
~~~
