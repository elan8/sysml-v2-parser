...
(parsed-document
  ...
  (root (package (name "DerivationConnectionRoles") (body (requirement-def (name "OriginalReq") (body semicolon)) (requirement-def (name "DerivedReq") (body semicolon)) (connection-def (name none) (role (derivation (span (offset 105) (line 4) (column 5) (len 11)))) (specializes none) (body (end (identity (derivation-role (kind original) (span (offset 142) (line 5) (column 13) (len 9)))) (typing none) (references (relationship (kind references) (implied false) (targets (ref r0)))) (redefines none) (crosses none)) (end (identity (derivation-role (kind derive) (span (offset 181) (line 6) (column 13) (len 7)))) (typing none) (references (relationship (kind references) (implied false) (targets (ref r1)))) (redefines none) (crosses none)))) (connection-def (name "Ordinary") (role ordinary) (specializes none) (body (end (identity (declaration (name "left") (span (offset 253) (line 9) (column 13) (len 4)))) (typing none) (references (relationship (kind references) (implied false) (targets (ref r2)))) (redefines none) (crosses none)))))))
)
~~~
