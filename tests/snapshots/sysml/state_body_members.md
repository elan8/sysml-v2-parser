...
(parsed-document
  ...
  (root (package (name "StateBodyMembers") (body (state-def (name "S") (body (attribute-usage (declaration-name none) (direction none) (typing none) (subsets none) (redefines (relationship (kind redefines) (implied false) (targets (ref r0)))) (references none) (crosses none) (intersects none) (value none) (body semicolon)) (action-usage) (action-usage) (succession-usage) (assert-constraint))))))
)
~~~
