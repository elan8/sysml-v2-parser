...
(parsed-document
  ...
  (root (package (name "DerivationEndRecovery") (body brace (connection-def (name none) (modifiers) (role (derivation (span (offset 36) (line 2) (column 5) (len 11)))) (specializes none) (body brace (malformed (code "recovered_connection_def_body_element") (found "end #mystery ::> Missing;") (span (offset 69) (line 3) (column 9) (len 34))) (end (introducer bare) (short-name none) (identity (derivation-role (kind derive) (span (offset 107) (line 4) (column 13) (len 7)))) (typing none) (references (relationship (kind references) (implied false) (targets (ref r0)))) (multiplicity none) (redefines none) (crosses none) (nested-usage none)))))))
)
~~~
