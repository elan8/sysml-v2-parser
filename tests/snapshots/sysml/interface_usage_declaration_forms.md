...
(parsed-document
  ...
  (root (package (name "InterfaceUsageDeclarationForms") (body brace (part-usage (then false) (prefix (direction none) (derived false) (variance none) (constant false) (reference false) (individual false) (portion none) (extensions)) (declaration-name "host") (short-name none) (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (value none) (body brace (interface-usage) (interface-usage) (interface-usage) (interface-usage) (interface-usage) (interface-usage))))))
)
~~~
