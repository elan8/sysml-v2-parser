...
(parsed-document
  ...
  (root (package (name "UsageBodyConnectorOwners") (body brace (part-def (name "Rig") (body brace (port-usage (declaration-name "left") (direction none) (typing none) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value none) (body semicolon)) (port-usage (declaration-name "right") (direction none) (typing none) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value none) (body semicolon)) (connect (from (expression (span (offset 109) (line 5) (column 17) (len 4)) (ref r0))) (to (expression (span (offset 117) (line 5) (column 25) (len 5)) (ref r1))) (body brace (doc) (attribute-usage (declaration-name "gauge") (direction none) (derived false) (usage-prefix none) (constant false) (reference false) (end false) (typing none) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value none) (body semicolon))) (subsets none) (redefines none)) (allocate))) (occurrence-def))))
)
~~~
