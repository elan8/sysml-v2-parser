...
(parsed-document
  ...
  (root (package (name "RequirementDefinitionBodyMembers") (body brace (requirement-def (name "Outer") (body brace (frame (concern-keyword true) (name "vs") (short-name none) (type (ref r0)) (body semicolon)) (requirement-def (name "Nested") (body semicolon)) (requirement-usage (name none) (multiplicity none)) (port-usage (declaration-name "evidence") (direction none) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r1)))) (subsets none) (redefines none) (references none) (crosses none) (intersects none) (value none) (body semicolon)) (allocation-usage) (attribute-usage))))))
)
~~~
