...
(parsed-document
  ...
  (root (package (name "AnnotatingUsageScopes") (body brace (part-usage (declaration-name "p") (typing none) (multiplicity-modifiers (ordered false) (nonunique false)) (body brace (port-usage) (interface-usage) (perform))) (view (name "v") (short-name none) (type none) (body brace (doc) (comment (keyword (span (offset 723) (line 24) (column 9) (len 7))) (name none) (about) (locale none)) (textual-rep) (metadata-annotation (prefixes) (introducer at) (declared-name none) (type (ref r0)) (about) (body semicolon)) (view-rendering))))))
)
~~~
