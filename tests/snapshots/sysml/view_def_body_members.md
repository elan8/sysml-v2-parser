...
(parsed-document
  ...
  (root (package (name "ViewDefBodyMembers") (body brace (view-def) (part-def (name "Ports") (body brace (ref (name "outgoingTransfersFromSelf") (short-name none) (prefix (direction none) (derived false) (usage-prefix none) (constant false)) (kind none) (typing none) (redefines none) (subsets (relationship (kind subsets) (implied false) (targets (ref r0)))) (body brace (end (short-name none) (identity (declaration (name "source") (span (offset 669) (line 17) (column 21) (len 6)))) (typing none) (references none) (redefines none) (crosses none)) (end (short-name none) (identity (declaration (name "target") (span (offset 697) (line 18) (column 21) (len 6)))) (typing none) (references none) (redefines none) (crosses none)))))) (rendering-def))))
)
~~~
