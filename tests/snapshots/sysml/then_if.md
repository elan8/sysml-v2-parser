...
(parsed-document
  ...
  (root (package (name "ThenIf") (body brace (action-def (name "DefinitionOwner") (modifiers) (specializes none) (body brace (then-if (if (condition (expression (span (offset 66) (line 3) (column 17) (len 5)) (ref r0))) (then (body brace (action-usage (name "yes") (short-name none) (prefix (abstract false) (variation false) (reference false) (individual false)) (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (body semicolon)))) (else none))))) (action-usage (name "UsageOwner") (short-name none) (prefix (abstract false) (variation false) (reference false) (individual false)) (typing none) (multiplicity none) (multiplicity-modifiers (ordering none) (uniqueness none)) (subsets none) (redefines none) (body brace (then-if (if (condition (expression (span (offset 155) (line 9) (column 17) (len 6)) (ref r1))) (then (body shorthand (then-control (join (declaration anonymous) (body semicolon (span (span (offset 171) (line 9) (column 33) (len 1)))))))) (else none))))))))
)
~~~
