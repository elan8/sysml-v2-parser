...
(parsed-document
  ...
  (root (package (name "SubjectDeclarations") (body brace (use-case-def (name "U") (modifiers) (body brace (subject (name "subj") (short-name none) (type none) (redefines (relationship (kind redefines) (implied false) (targets (ref r0)))) (value none) (body semicolon)))) (requirement-def (name "R1") (modifiers) (body brace (subject (name "") (short-name none) (type none) (redefines (relationship (kind redefines) (implied false) (targets (ref r1)))) (value (feature-value (kind bind) (default false) (expression (expression (span (offset 149) (line 6) (column 31) (len 13)) (ref r2))))) (body semicolon)))) (requirement-def (name "R2") (modifiers) (body brace (subject (name "generateTorque") (short-name none) (type none) (redefines none) (value (feature-value (kind bind) (default true) (expression (expression (span (offset 234) (line 9) (column 40) (len 22)) (member-access (base (expression (span (offset 234) (line 9) (column 40) (len 7)) (ref r3))) (separator dot) (member (ref r4))))))) (body semicolon)))) (requirement-def (name "R3") (modifiers) (body brace (subject (name "vehicle") (short-name none) (type (ref r5)) (redefines none) (value (feature-value (kind bind) (default false) (expression (expression (span (offset 325) (line 12) (column 37) (len 11)) (ref r6))))) (body semicolon)))) (requirement-def (name "R4") (modifiers) (body brace (subject (name "subj") (short-name none) (type (ref r7)) (redefines (relationship (kind redefines) (implied false) (targets (ref r8)))) (value none) (body semicolon)))) (connection-def (name "C") (modifiers) (role ordinary) (specializes none) (body brace (end (short-name none) (identity (declaration (name "source") (span (offset 473) (line 18) (column 17) (len 6)))) (typing none) (references none) (redefines none) (crosses none)) (end (short-name none) (identity (declaration (name "target") (span (offset 493) (line 19) (column 13) (len 6)))) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r9)))) (references none) (redefines none) (crosses none)))))))
)
~~~
