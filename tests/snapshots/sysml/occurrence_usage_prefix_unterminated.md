...
~~~sexpr
(fixture-diagnostics
  (document "occurrence_usage_prefix_unterminated.md"
    (diagnostics
      (diagnostic (code "missing_closing_brace") (severity none) (category parseerror) (span (offset 196) (line 8) (column 2) (len 1)) (message "missing closing '}'"))
    )
  )
)
~~~
...
(parsed-document
  ...
  (root (malformed (code "missing_closing_brace") (found none) (span (offset 0) (line 1) (column 1) (len 196))))
)
~~~
