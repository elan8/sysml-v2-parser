...
(parsed-document
  ...
  (root (package (name "TypeBodyPackageMembers") (body brace (kerml-classifier (keyword class) (abstract false) (name "Outer") (specializes none) (conjugates none) (body brace (package-member (visibility public) (package (name "Inner") (body brace (kerml-classifier (keyword type) (abstract false) (name "Nested") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r0)))) (conjugates none) (body semicolon))))) (library-package-member (visibility private) (library-package (name "StandardInner") (standard true) (body brace (kerml-classifier (keyword type) (abstract false) (name "Unit") (specializes (typing (kind subclassification) (conjugated false) (implied false) (targets (ref r1)))) (conjugates none) (body semicolon))))) (alias (name "outerAlias") (target (ref r2)) (body semicolon)))))))
)
~~~
