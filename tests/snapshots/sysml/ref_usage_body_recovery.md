...
(parsed-document
  ...
  (root (interface-def (name "Broken") (specializes none) (body (ref (name "") (kind port) (typing (typing (kind typing) (conjugated false) (implied false) (targets (ref r0)))) (redefines (relationship (kind redefines) (implied false) (targets (ref r1)))) (subsets none) (body (malformed (code "recovered_ref_body_element") (found "!!not a member;") (span (offset 69) (line 3) (column 9) (len 24))) (ref (name "thisParticipant") (kind none) (typing none) (redefines (relationship (kind redefines) (implied false) (targets (ref r2)))) (subsets none) (body semicolon)))))))
)
~~~
